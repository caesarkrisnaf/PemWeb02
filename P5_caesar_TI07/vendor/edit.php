            ...
            <div class="form-group row">
                ...
                <div class="col-8">
                    <div class="input-group">
                        ...
                        <input id="nomor" name="nomor"  type="text" class="form-control" required="required" value="<?php echo $hasil['nomor']; ?>">
                    </div>
                </div>
            </div>
            <div class="form-group row">
                ...
                <div class="col-8">
                    <div class="input-group">
                        ...
                        <input id="nama" name="nama"  type="text" class="form-control" required="required" value="<?php echo $hasil['nama'];?>">
                    </div>
                </div>
            </div>
            <div class="form-group row">
                ...
                <div class="col-8">
                    <div class="input-group">
                        ...
                        <input id="kota" name="kota"  type="text" class="form-control" required="required" value="<?php echo $hasil['kota'];?>">
                    </div>
                </div>
            </div>
            <div class="form-group row">
                ...
                <div class="col-8">
                    <div class="input-group">
                        ...
                        <input id="kontak" name="kontak" type="text" class="form-control" value="<?php echo $hasil['kontak'];?>">
                    </div>
                </div>
            </div>
            <div class="form-group row">
